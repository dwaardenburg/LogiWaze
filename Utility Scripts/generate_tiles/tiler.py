...
source_img = Image.open('images/map.png')
target_dir = 'images/Tiles/'

#clear tiles target folder
...
#find max zoom level
max_zoom_lvl = math.log(max_dim / tile_size) / math.log(2)
max_zoom_lvl = int(math.ceil(max_zoom_lvl))
