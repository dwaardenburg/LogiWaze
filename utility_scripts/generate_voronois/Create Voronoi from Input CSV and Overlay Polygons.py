...
hexShape = projectpath+'/HexPolygon.geojson'
towns = projectpath+'/towns.geojson'
...
outputtemp = projectpath+'/temp'
print(outputtemp)
ensure_dir(outputtemp)

output = outputtemp+'/merged_towns.geojson'
...
processing.run("qgis:splitvectorlayer", {'INPUT':hexShape, 'FIELD':'HexID', 'OUTPUT':outputhexshape})
...
outputFinal=projectpath+'/done/VoronoiHexID'
